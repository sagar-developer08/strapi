...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blog_info: Schema.Attribute.Text;
...
export interface ApiSpecialPromotionSpecialPromotion
  extends Struct.CollectionTypeSchema {
  collectionName: 'special_promotions';
  info: {
    description: '';
    displayName: 'Special Promotion';
    pluralName: 'special-promotions';
    singularName: 'special-promotion';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::special-promotion.special-promotion': ApiSpecialPromotionSpecialPromotion;
